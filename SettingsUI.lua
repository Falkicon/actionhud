...
Use |cffffffffAdvanced Cooldown Settings|r to configure tracked spells.]],
            ...
            fontSize = {
                name = "Stack Font Size", type = "range", min=8, max=24, step=1, order=26,
            ...
            debug = {
                name = "Debug Discovery", desc = "Print widget IDs to chat to help identify frames.", type = "toggle", order = 30,
