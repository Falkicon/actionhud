		...
		if updateInfo.addedAuras then
			for _, aura in ipairs(updateInfo.addedAuras) do
				...
				if isTestSpell and spellId then
					...
					addon:Log(
						"DefensiveTracker: [3] Cached "
							.. TEST_SPELLS[spellId]
							.. " via addedAuras (instanceID="
			...
			elseif durationObj then
				...
				local ok5 = pcall(function()
					...
					if expTime and duration and duration > 0 then
						...
						addon:Log(
							"DefensiveTracker: [5] SetCooldown SUCCESS (exp="
								.. tostring(expTime)
								.. ", dur="
								.. tostring(duration)
								.. ")",
...
function DefensiveTracker:SetLayoutMode(enabled) end

function DefensiveTracker:UpdateSettings() end
